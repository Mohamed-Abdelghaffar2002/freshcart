...
export default function Cart() {
  ...
  return (
    <>
      {cart ? (cart.numOfCartItems==0?<div className="center pt-8 ">{<img className="w-full sm:w-1/2" src={img} alt="empty cart"/>}</div>:
        <div className="relative pb-10 overflow-x-auto shadow-md sm:rounded-lg">
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center">
                        <button
                          onClick={() =>
                            updateProductAtCart(item.product.id, item.count - 1)
                          }
